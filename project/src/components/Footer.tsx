        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Dedicated to excellence in education, research, and innovation. Building tomorrow's leaders today.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/student-corner" className="text-gray-400 hover:text-white">Student Corner</Link>
              </li>
            </ul>
          </div>
